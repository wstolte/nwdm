...
```{r}
locs <- readr::read_csv("http://al-276.xtr.deltares.nl:8080/geoserver/NWDM/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=NWDM:location&outputFormat=csv") %>% 
