...
```{r, fig.cap="Random sample of 1000 locations in the NWDM database."}
...
```{r example1, fig.height=4, fig.width = 8, fig.cap="Example of seasonal variation of nitrate concentration at location DOOVBWT. "}
